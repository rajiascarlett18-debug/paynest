...
export class AdminService {
  ...
  createBill(data: any) {
   return this.http.post(`${this.API}/bills`, data, this.headers());
  }

  getAnalytics() {
  return this.http.get(`${this.API}/analytics`, this.headers());
}

  getTransactions() {
  return this.http.get(`${this.API}/transactions`, this.headers());
}
